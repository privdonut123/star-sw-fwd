   ...
   */
    ...
    */
    ...
    vector<Seed_t> doTrackingOnHitmapSubset( size_t iIteration, FwdDataSource::HitMap_t &hitmap  ) {
        LOG_INFO << "TRACKING SUBSET" << endm;
        // for ( auto kv:hitmap ) {
        //     for ( auto h : kv.second ) {
        //         LOG_INFO << "H x:" << h->getX() << ", " <<  h->getY() << ", " << h->getZ() << endm;
        //     }
        // }
