...
void event_track(    int n = 5,
                    const char *inFile = "/gpfs01/star/pwg_tasks/FwdCalib//PROD/out/st_physics_23072003_raw_0000003.event.root",
    ...
    _chain = Form("in, %s, db, MakeEvent, fwdTrack", geom);
