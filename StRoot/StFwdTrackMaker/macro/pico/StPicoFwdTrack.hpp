...
public:
    ...
    TLorentzVector fourMomentum(double m) const {  return TLorentzVector(mMomentumX, mMomentumY, mMomentumZ, TMath::Sqrt(mMomentumX*mMomentumX + mMomentumY*mMomentumY + mMomentumZ*mMomentumZ + m*m));} 
