...
private:
    ...
    UChar_t mPlane       = 0; // Detector plane
    UChar_t mQuadrant    = 0; // Detector quadrant
    UChar_t mRow         = 0; // Detector row
    ...
    StPtrVecFttPoint mPoints;         // Fitted points using this cluster
